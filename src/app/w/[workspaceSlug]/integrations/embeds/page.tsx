...
import { EmbedDeploymentsPanel } from "@/features/integrations/components/embed-deployments-panel";
import { requireWorkspaceAccess } from "@/server/auth/dal";

export const metadata: Metadata = { title: "Embeds" };

export default async function EmbedsPage({ params }: PageProps<"/w/[workspaceSlug]/integrations/embeds">) {
